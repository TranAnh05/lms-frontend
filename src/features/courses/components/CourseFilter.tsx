...
// Cấu hình style cho icon mũi tên của select dropdown
...
export const CourseFilter: React.FC<CourseFilterProps> = memo(
    ({
        searchTerm,
        onSearchChange,
        departments,
                    ...
                    <div className="relative w-full sm:w-64">
                        ...
                        <select
                            ...
                            onChange={(e) => {
                                ...
                                onDeptChange(val ? Number(val) : null);
                            }}
