...
// Cau hinh UI Role giu nguyen ben ngoai component de tranh cap phat lai bo nho
...
// Toi uu: Dua ham xu ly chuoi ra ngoai vong doi render cua Component
...
const ActionMenu: React.FC<ActionMenuProps> = ({ user, index, total, onView, onEdit, onToggleLock }) => {
    ...
    return (
        <div className="relative flex justify-center" ref={menuRef}>
            ...
            {isOpen && (
                ...
                >
                    <button
                        onClick={() => handleAction(onView, user.id)}
                    ...
                    >
                        <Edit className="w-4 h-4" /> Cập nhật dữ liệu
                    </button>
...
// Toi uu: Boc React.memo de ngan Table render lai khi form filter hoac modal cua component cha thay doi state
...
// Hien thi ten component ro rang trong React DevTools sau khi dung memo
