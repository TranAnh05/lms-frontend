        ...
        return (
            <div className="flex flex-col items-center justify-center min-h-[70vh]">
                ...
                <p className="text-gray-500 mt-1">
                    Có lỗi xảy ra trong quá trình trích xuất dữ liệu của bạn.
                </p>
            </div>
        );
    }
        ...
        <div className="max-w-6xl mx-auto space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div>
                ...
                <p className="text-sm text-gray-500 mt-1">
                    Xem thông tin chi tiết và cập nhật ảnh đại diện của bạn.
                </p>
            </div>
            ...
            <div className="flex flex-col lg:flex-row gap-6">
                ...
                <div className="w-full lg:w-1/3 space-y-6">
                    ...
                    <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
                        ...
                        <p className="text-sm text-gray-500 mb-5">
                            Nên cập nhật mật khẩu thường xuyên để bảo vệ tài
                            khoản của bạn.
                        </p>
                        <button
                ...
                <div className="w-full lg:w-2/3 space-y-6">
                    ...
                    {(isStudent || isTeacher) && (
                        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 sm:p-8">
                            {isStudent && (
                                <StudentInfoSection profile={profile} />
                            )}
                            {isTeacher && (
                                <TeacherInfoSection profile={profile} />
                            )}
                        </div>
                    )}
                </div>
