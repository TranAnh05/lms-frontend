...
// Su dung React.memo de tranh re-render khi danh sach thoi khoa bieu hoac trang thai loading o component cha thay doi
export const TimetableHeader: React.FC<TimetableHeaderProps> = React.memo(
    ({ currentDate, onPrevWeek, onNextWeek, onToday }) => {
        return (
            <header className="bg-white rounded-xl border border-gray-200 shadow-sm p-4 flex flex-col sm:flex-row items-center justify-between gap-4">
