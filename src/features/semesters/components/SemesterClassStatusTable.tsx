...
export const SemesterClassStatusTable: React.FC<SemesterClassStatusTableProps> =
    memo(({ classes, isLoading }) => {
        if (isLoading) {
            return (
                ...
                <div className="max-h-[400px] overflow-y-auto custom-scrollbar">
                    <table className="w-full text-left text-sm text-gray-600 table-auto">
                        ...
                        <tbody className="divide-y divide-gray-100">
                            {classes.map((cls) => {
                                // Toi uu: Them fallback de bao ve UI khong bi crash neu API tra ve status la
...
SemesterClassStatusTable.displayName = "SemesterClassStatusTable";
