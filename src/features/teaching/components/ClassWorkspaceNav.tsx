...
export const ClassWorkspaceNav: React.FC = () => {
    ...
    // Tối ưu: Dùng useMemo để tránh khởi tạo lại mảng điều hướng khi component re-render
    ...
    return (
        <div className="bg-white border-b border-gray-200">
            {/* Thanh cuộn ngang hỗ trợ hiển thị tốt trên thiết bị di động */}
            <nav
                className="flex space-x-1 sm:space-x-8 px-4 sm:px-6 overflow-x-auto custom-scrollbar"
                aria-label="Tabs"
            >
                {navItems.map((item) => (
                    <NavLink
